 ...
 <?php echo form_open(site_url("tasks/edit_task_pro/" . $task->ID), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <!--<option value="2" <?php if($task->status == 3) echo "selected" ?>><?php echo lang("ctn_8311") ?></option> PENDNG NOTE-->
                        <option value="4" <?php if($task->status == 3) echo "selected" ?>><?php echo lang("ctn_832") ?></option>
                        <option value="5" <?php if($task->status == 4) echo "selected" ?>><?php echo lang("ctn_833") ?></option>
                        <option value="6" <?php if($task->status == 5) echo "selected" ?>><?php echo lang("ctn_834") ?></option>
                        </select>
                    </div>
            </div>
            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="checkbox" name="archived" value="1" <?php if($task->archived) echo"unchecked" ?>>
