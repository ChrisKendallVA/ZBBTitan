<ul class="newnav nav nav-sidebar">
           ...
           ($this->user->info->admin || $this->user->info->admin_settings || $this->user->info->admin_members || $this->user->info->admin_payment)
            ...
            <hr />
              <li class="<?php if(isset($activeLink['home']['general']))  ?>"><a href="<?php echo site_url() ?>"><span class="glyphicon glyphicon-home sidebar-icon sidebar-icon-blue"></span> <?php echo lang("ctn_688") ?> <span class="sr-only">(current)</span></a></li>
              <li id="admin_sb">
                  ...
                  <ul class="inner-sidebar-links">
                   <li class="<?php if(isset($activeLink['admin']['general'])) echo "active" ?>"><a href="<?php echo site_url("admin") ?>"> <?php echo lang("ctn_682") ?></a></li>
                    ...
                    <?php if($this->user->info->admin) : ?>
                      ...
                      <li class="<?php if(isset($activeLink['admin']['tools'])) echo "active" ?>"><a href="<?php echo site_url("projects") ?>">Your Projects</a></li>
                      <li class="<?php if(isset($activeLink['admin']['tools'])) echo "active" ?>"><a href="<?php echo site_url("projects/all") ?>">All Projects Projects</a></li>
                      <li class="<?php if(isset($activeLink['admin']['tools'])) echo "active" ?>"><a href="<?php echo site_url("projects/cats") ?>">Project Categories</a></li>
                      <li class="<?php if(isset($activeLink['admin']['tools'])) echo "active" ?>"><a href="<?php echo site_url("projects/custom_fields") ?>">Project Custom Fields</a></li>
                    <?php endif; ?>
                  </ul>
                </div>
              </li>
            ...
            <?php if($this->settings->info->enable_tasks && $this->common->has_permissions(array("admin", "project_admin", "task_worker", "task_manage", "task_client"), $this->user)) : ?>
              ...
              <!--<li id="task_links">
                  <a data-toggle="collapse" data-parent="#task_links" href="#task_links_c" class="collapsed <?php if(isset($activeLink['task'])) echo "active" ?>" >
                    <span class="glyphicon glyphicon-tasks sidebar-icon sidebar-icon-pink"></span> Task Manager
              ...
              <li id="task_links">
                  ...
                  <div id="task_links_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['task'])) echo "in" ?>">
                    <ul class="inner-sidebar-links">
                  <li class="<?php if(isset($activeLink['task']['general'])) ?>"><a href="//titan.zonebroadband.co.uk/index.php/tasks/add?projectid=0"> Create a Task</a></li>
                  <li class="<?php if(isset($activeLink['task']['general'])) ?>"><a href="//titan.zonebroadband.co.uk/index.php/tasks/templates">  - Task Templates</a></li>
              <li class="<?php if(isset($activeLink['task']['general'])) ?>"><a href="//titan.zonebroadband.co.uk/index.php/tasks/assigned"> My Tasks</a></li>
              <li class="<?php if(isset($activeLink['task']['general'])) ?>"><a href="//titan.zonebroadband.co.uk/index.php/tasks/all"> All Tasks</a></li>
              <li class="<?php if(isset($activeLink['task']['general'])) ?>"><a href="//titan.zonebroadband.co.uk/index.php/tasks/archived"> Archived Tasks</a></li>
            ...
            <li id="projects_links">
                <a data-toggle="collapse" data-parent="#projects_links" href="#projects_links_c" class="collapsed <?php if(isset($activeLink['projects'])) echo "active" ?>" >
                  <span class="glyphicon glyphicon-folder-open sidebar-icon sidebar-icon-green"></span> Master Project Manager
          ...
          <?php if($this->settings->info->enable_files && $this->common->has_permissions(array("admin", "project_admin", "file_worker", "file_manage"), $this->user)) : ?>
              ...
              <!-- Added Upload file link -->
          <li class="<?php if(isset($activeLink['task']['general'])) ?>"><a href="//titan.zonebroadband.co.uk/index.php/files/add_file/0"> Upload a File</a></li>
            <?php endif; ?>
                        <hr />
            ...
            <?php if($this->settings->info->enable_stock && $this->common->has_permissions(array("admin", "project_admin", "stock_worker", "stock_manage"), $this->user)) : ?>
              <li id="stock_links">
                  <a data-toggle="collapse" data-parent="#stock_links" href="#stock_links_c" class="collapsed <?php if(isset($activeLink['stock'])) echo "active" ?>" >
                    <span class="glyphicon glyphicon-stats sidebar-icon sidebar-icon-blue"></span> <?php echo lang("ctn_1575") ?>
                    <span class="plus-sidebar"><span class="glyphicon <?php if(isset($activeLink['stock'])) : ?>glyphicon-menu-down<?php else : ?>glyphicon-menu-right<?php endif; ?>"></span></span>
                  </a>
                  <div id="stock_links_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['stock'])) echo "in" ?>">
                    <ul class="inner-sidebar-links">
                      <?php if($this->common->has_permissions(array("admin", "project_admin", "stock_manage"), $this->user)) : ?>
                        <li class="<?php if(isset($activeLink['stock']['general'])) echo "active" ?>"><a href="<?php echo site_url("stock") ?>"> <?php echo lang("ctn_1590") ?></a></li>
                      <li class="<?php if(isset($activeLink['stock']['all'])) echo "active" ?>"><a href="<?php echo site_url("stock/inventory_all") ?>"><?php echo lang("ctn_1591") ?></a></li>
                      <?php endif; ?>
                      <li class="<?php if(isset($activeLink['stock']['inventory'])) echo "active" ?>"><a href="<?php echo site_url("stock/inventory") ?>"><?php echo lang("ctn_1592") ?></a></li>
                    </ul>
                  </div>
              </li>
            <?php endif; ?>
              ...
              <li id="invoice_links">
                  ...
                  <div id="invoice_links_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['invoice'])) echo "in" ?>">
                    ...
                    <?php endif; ?>
                      ...
                      <li class="<?php if(isset($activeLink['invoice']['estimates'])) echo "active" ?>"><a href="<?php echo site_url("invoices/estimates") ?>"> <?php echo lang("ctn_1594") ?></a></li>
                      ...
                      <li class="<?php if(isset($activeLink['invoice']['custom'])) echo "active" ?>"><a href="<?php echo site_url("invoices/custom") ?>"> <?php echo lang("ctn_714") ?></a></li>
                    <?php endif; ?>
                      ...
                      <li class="<?php if(isset($activeLink['invoice']['client_estimate'])) echo "active" ?>"><a href="<?php echo site_url("invoices/client_estimate") ?>"> <?php echo lang("ctn_1597") ?></a></li>
                    </ul>
                  </div>
              </li>
            <?php endif; ?>
			...
			<?php if($this->settings->info->enable_team && $this->common->has_permissions(array("admin", "project_admin", "team_worker", "team_manage"), $this->user)) : ?>
              <li id="team_links">
                  ...
                  <div id="team_links_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['team'])) echo "in" ?>">
                    <ul class="inner-sidebar-links">
                      <li class="<?php if(isset($activeLink['team']['general'])) echo "active" ?>"><a href="<?php echo site_url("team") ?>"> <?php echo lang("ctn_1596") ?></a></li>
