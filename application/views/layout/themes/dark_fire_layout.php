...
<?php endif; ?>
    ...
    <nav class="navbar navbar-inverse navbar-header2">
      <div class="container-fluid">
        ...
        <?php endif; ?>
            <li><a href="https://titan.zonebroadband.co.uk/index.php/home/notifications" data-target="#" onclick="https://titan.zonebroadband.co.uk/index.php/home/notifications"><span class="glyphicon glyphicon-bell notification-icon"></span><?php if($this->user->info->noti_count > 0) : ?><span class="badge notification-badge small-text"><?php echo $this->user->info->noti_count ?></span><?php endif; ?></a>
            <!--<li><a href="index.php/home/notifications"><span class="glyphicon glyphicon-bell notification-icon"></span><span class="badge notification-badge small-text">3</span></a>><span class="glyphicon glyphicon-bell notification-icon"></span><?php if($this->user->info->noti_count > 0) : ?><span class="badge notification-badge small-text"><?php echo $this->user->info->noti_count ?></span><?php endif; ?></a>-->
            ...
            <li><a href="https://titan.zonebroadband.co.uk/index.php/mail" data-target="#" onclick="https://titan.zonebroadband.co.uk/index.php/mail" ><span class="glyphicon glyphicon-envelope notification-icon"></span><?php if($this->user->info->email_count > 0) : ?><span class="badge notification-badge small-text"><?php echo $this->user->info->email_count ?></span><?php endif; ?></a>
    ...
    <div id="footer" class="clearfix">
      <span class="pull-left"><?php echo $this->settings->info->copyright_footer ?></span> <span class="pull-right"><a href="<?php echo site_url("home/change_language") ?>"><?php echo lang("ctn_171") ?></a></span>
    </div>
