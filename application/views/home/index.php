...
<div class="col-md-3">
<?php if( ($this->settings->info->enable_tasks && $this->common->has_permissions(array("admin", "project_admin", "task_worker", "task_manage"), $this->user)) || ($this->settings->info->enable_notes && $this->common->has_permissions(array("admin", "project_admin", "notes_manage", "notes_worker"), $this->user)) ) : ?>
<div class="panel panel-default">
<div class="panel-body" id="scroll-window">

<p><?php if($this->settings->info->enable_tasks && $this->common->has_permissions(array("admin", "project_admin", "task_worker", "task_manage"), $this->user) ) : ?><button type="button" class="btn btn-flat btn-xs" id="tasks-btn" onclick="get_tasks()">Tasks</button><?php endif; ?> <?php if($this->settings->info->enable_notes && $this->common->has_permissions(array("admin", "project_admin", "notes_manage", "notes_worker"), $this->user)) : ?><button type="button" id="notes-btn" class="btn btn-flat btn-xs" onclick="get_notes()">Notes</button><?php endif; ?></p>
